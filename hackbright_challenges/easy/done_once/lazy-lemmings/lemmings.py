...
#         # loop through cafes, and find the smallest absolute value of 
#         # hole - cafe. the absolute value is simply the distance in this case
#         # hole - cafe is the distance from hole to cafe
